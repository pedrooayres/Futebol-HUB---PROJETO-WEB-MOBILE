...
export const API_FOOTBALL_LEAGUES = [
  { appId: "bra.1", apiId: 71, label: "Brasileirao Serie A", country: "Brazil", season: "2026", type: "League", search: "Serie A" },
  { appId: "bra.2", apiId: 72, label: "Brasileirao Serie B", country: "Brazil", season: "2026", type: "League", search: "Serie B" },
  { appId: "bra.3", apiId: null, label: "Brasileirao Serie C", country: "Brazil", season: "2026", type: "League", search: "Serie C" },
  { appId: "bra.4", apiId: null, label: "Brasileirao Serie D", country: "Brazil", season: "2026", type: "League", search: "Serie D" },
  { appId: "eng.1", apiId: 39, label: "Premier League", country: "England", season: "2025", type: "League", search: "Premier League" },
  { appId: "eng.2", apiId: 40, label: "EFL Championship", country: "England", season: "2025", type: "League", search: "Championship" },
  { appId: "esp.1", apiId: 140, label: "LaLiga", country: "Spain", season: "2025", type: "League", search: "La Liga" },
  { appId: "fra.1", apiId: 61, label: "Ligue 1", country: "France", season: "2025", type: "League", search: "Ligue 1" },
  { appId: "ita.1", apiId: 135, label: "Serie A Italia", country: "Italy", season: "2025", type: "League", search: "Serie A" },
  { appId: "ger.1", apiId: 78, label: "Bundesliga", country: "Germany", season: "2025", type: "League", search: "Bundesliga" },
  { appId: "por.1", apiId: 94, label: "Liga Portugal", country: "Portugal", season: "2025", type: "League", search: "Primeira Liga" },
  { appId: "sau.1", apiId: 307, label: "Liga Saudita", country: "Saudi-Arabia", season: "2025", type: "League", search: "Pro League" },
  { appId: "ucl", apiId: 2, label: "Champions League", country: "World", season: "2025", type: "Cup", search: "UEFA Champions League" },
  { appId: "uel", apiId: 3, label: "Europa League", country: "World", season: "2025", type: "Cup", search: "UEFA Europa League" },
  { appId: "uecl", apiId: 848, label: "Conference League", country: "World", season: "2025", type: "Cup", search: "UEFA Europa Conference League" },
  { appId: "libertadores", apiId: 13, label: "Libertadores", country: "World", season: "2026", type: "Cup", search: "CONMEBOL Libertadores" },
  { appId: "sudamericana", apiId: 11, label: "Sul-Americana", country: "World", season: "2026", type: "Cup", search: "CONMEBOL Sudamericana" },
  { appId: "copa-do-brasil", apiId: 73, label: "Copa do Brasil", country: "Brazil", season: "2026", type: "Cup", search: "Copa do Brasil" },
  { appId: "copa-do-nordeste", apiId: null, label: "Copa do Nordeste", country: "Brazil", season: "2026", type: "Cup", search: "Copa do Nordeste" },
  { appId: "copa-del-rey", apiId: 143, label: "Copa do Rei", country: "Spain", season: "2025", type: "Cup", search: "Copa del Rey" },
  { appId: "fa-cup", apiId: 45, label: "FA Cup", country: "England", season: "2025", type: "Cup", search: "FA Cup" },
  { appId: "carabao-cup", apiId: 48, label: "Carabao Cup", country: "England", season: "2025", type: "Cup", search: "League Cup" },
  { appId: "dfb-pokal", apiId: 81, label: "Copa da Alemanha", country: "Germany", season: "2025", type: "Cup", search: "DFB Pokal" },
  { appId: "taca-portugal", apiId: 97, label: "Copa de Portugal", country: "Portugal", season: "2025", type: "Cup", search: "Taca de Portugal" },
  { appId: "coupe-france", apiId: 66, label: "Copa da Franca", country: "France", season: "2025", type: "Cup", search: "Coupe de France" },
  { appId: "supercopa-brasil", apiId: null, label: "Supercopa do Brasil", country: "Brazil", season: "2026", type: "Cup", search: "Supercopa do Brasil" },
  { appId: "community-shield", apiId: null, label: "Supercopa da Inglaterra", country: "England", season: "2025", type: "Cup", search: "Community Shield" },
  { appId: "dfl-supercup", apiId: null, label: "Supercopa da Alemanha", country: "Germany", season: "2025", type: "Cup", search: "Super Cup" },
  { appId: "supercoppa-italia", apiId: null, label: "Supercopa da Italia", country: "Italy", season: "2025", type: "Cup", search: "Super Cup" },
  { appId: "trophee-des-champions", apiId: null, label: "Supercopa da Franca", country: "France", season: "2025", type: "Cup", search: "Trophee des Champions" },
  { appId: "supertaca", apiId: null, label: "Super Taca de Portugal", country: "Portugal", season: "2025", type: "Cup", search: "Supertaca" },
  { appId: "world-cup", apiId: 1, label: "Copa do Mundo", country: "World", season: "2026", type: "Cup", search: "World Cup" },
  { appId: "copa-america", apiId: 9, label: "Copa America", country: "World", season: "2025", type: "Cup", search: "Copa America" },
  { appId: "euro", apiId: 4, label: "Eurocopa", country: "World", season: "2025", type: "Cup", search: "Euro Championship" },
  { appId: "club-world-cup", apiId: 15, label: "Mundial de Clubes", country: "World", season: "2025", type: "Cup", search: "Club World Cup" },
  { appId: "super-club-world-cup", apiId: 15, label: "Super Mundial de Clubes", country: "World", season: "2025", type: "Cup", search: "Club World Cup" }
];
...
async function resolveApiFootballLeague(leagueConfig, season) {
  ...
  if (!candidate?.league?.id) {
    throw new Error(`Competicao nao encontrada na API-Football: ${leagueConfig.label}.`);
  }
...
export async function getApiFootballTeamSnapshot({ name, leagueId, season = "2025" }) {
  ...
  if (!candidate?.team?.id) {
    throw new Error("Time nao encontrado na API-Football.");
  }
...
export async function getApiFootballPlayerSnapshot({ name, season = "2025" }) {
  ...
  if (!candidate?.player?.id) {
    throw new Error("Jogador nao encontrado na API-Football.");
  }
