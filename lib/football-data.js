...
export function getTeamBySlug(slug) {
  return featuredTeams.find((team) => team.slug === slug) || buildGeneratedTeamProfile(slug);
}

export function getPlayerBySlug(slug) {
  return spotlightPlayers.find((player) => player.slug === slug) || buildGeneratedPlayerProfile(slug);
}
