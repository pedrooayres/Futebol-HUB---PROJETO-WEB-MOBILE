...
export function buildGeneratedTeamProfile(input) {
  ...
  return {
    ...
    moment: "Clube detectado pela busca, em fase de entrada no monitoramento do produto.",
    ...
    strengths: ["Cobertura imediata de busca", "Entrada automatica no monitoramento", "Pronto para enriquecimento posterior"],
    ...
    recentForm: [
      { opponent: "A definir", score: "0-0", result: "E", venue: "Monitoramento" },
      { opponent: "A definir", score: "0-0", result: "E", venue: "Monitoramento" },
      { opponent: "A definir", score: "0-0", result: "E", venue: "Monitoramento" }
    ],
    homeAway: {
    ...
    streaks: [
      ...
      "Clube adicionado ao monitoramento do produto"
    ],
    advancedMetrics: {
      goalsPerMatch: 0,
      shotsOnTarget: 0,
    ...
    topPerformers: ["Sem destaques confirmados ainda", "Pipeline externo pendente", "Aguardando enriquecimento de dados"],
    probableLineup: {
      formation: "4-3-3",
...
export function buildGeneratedPlayerProfile(input) {
  ...
  return {
    ...
    strengths: ["Cobertura automatica de busca", "Pronto para enriquecimento posterior", "Entrada imediata no monitoramento"],
    ...
    recommendations: [
      ...
      "Atualizar perfil quando o pipeline completar os dados"
    ],
    metrics: {
      technique: 70,
      physical: 70,
    ...
    recentMatches: [
      ...
      "Pode ser enriquecido por novas fontes de dados"
    ],
    availability: {
